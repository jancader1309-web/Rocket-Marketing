...
VERIFY_TOKEN       = os.environ.get("FB_VERIFY_TOKEN", "rocketmarketing2026")
...
def send_reminders():
    ...
    for event in events:
        ...
        reminder_text = (
            f"Czesc {imie}! Przypominamy o jutrzejszej wizycie w Rocket Marketing ✂️\n\n"
            f"Data: {data}\n"
            f"Godzina: {godz}\n"
            f"Usluga: {usluga}"
            f"{barber_info}\n\n"
...
def send_review_requests():
    ...
    for event in events:
        ...
        review_text = (
            f"Czesc {imie}! Dziekujemy za odwiedziny w Rocket Marketing ✂️\n\n"
...
def build_system_message(sender_id=""):
    ...
    return (
        "Jestes asystentem Rocket Marketing. Mow po polsku.\n\n"
        "SALON:\n"
...
<title>Rocket Marketing Bot</title>
</head>
<body><h1>Rocket Marketing Bot API</h1></body>
</html>"""
